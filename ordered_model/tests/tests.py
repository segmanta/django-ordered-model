...
from ordered_model.tests.models import Answer, Item, Question, User, CustomItem, CustomOrderFieldModel, Pizza, Topping, PizzaToppingsThroughModel
import uuid
...
class TupleMultiOrderWithRespectToTests(TestCase):
    def setUp(self):
        q1 = Question.objects.create()
        q2 = Question.objects.create()
